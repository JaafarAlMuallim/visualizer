...
import { animateDivs } from "@/algorithms/animate";
  ...
  const sort = (type: Algo) => {
    switch (type) {
      ...
      case "merge":
        ...
        // getMergeSortAnims(mergeNums, mergeAnim, mergeArr, 0, items.length - 1);
        // animateMerge({ newArr: mergeNums, mergeArr, setItems, settings });
        break;
      case "bubble":
